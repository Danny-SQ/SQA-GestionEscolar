...
<body>
<div class="header">
    <h1>Registro de Notas - Gestion Escolar</h1>
...
<div class="body">
    <div class="panel">
        ...
        if(!isset($_GET['consultar'])){
            ...
            <form method="get" class="form" action="listadonotas.view.php">
                ...
                <br><br>
                <label>Seleccione el Paralelo</label><br><br>

                <?php foreach ($secciones as $seccion):?>
                    <input type="radio" name="seccion" required value="<?php echo $seccion['id'] ?>">Paralelo <?php echo $seccion['nombre'] ?>
                <?php endforeach;?>
 ...
 where id_grado = ".$id_grado." and id_seccion = ".$id_seccion." group by a.id");
            ...
            <a class="btn-link" href="" onclick="window.print()">Imprimir</a>
            <a class="btn-link" href="generarcsv.php">Generar CSV</a>
            <br>
            <br>
